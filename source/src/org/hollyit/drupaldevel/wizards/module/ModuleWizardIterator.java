...
public final class ModuleWizardIterator implements WizardDescriptor.InstantiatingIterator {
    ...
    private WizardDescriptor.Panel[] getPanels() {
        ...
        if (panels == null) {
            getTargetFolder();
            panel2 = new ModuleWizardPanel2(getTargetFolder());
            panels = new WizardDescriptor.Panel[]{
                new ModuleWizardPanel1(),
                panel2
            };
    ...
    public Set<FileObject> instantiate() throws IOException {
        ...
        for (int i = 0; i < fileList.size(); i++) {
            ...
            WizardUtils.generateFile(file, this.drupalVersion, "module", name, src, this.safeName, this.moduleName);
