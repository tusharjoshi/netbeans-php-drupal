...
public final class ThemeWizardWizardIterator implements WizardDescriptor.InstantiatingIterator {
   ...
   private WizardDescriptor.Panel[] getPanels() {
        ...
        if (panels == null) {
            getTargetFolder();
            panel2 = new ThemeWizardWizardPanel2(getTargetFolder());
            panels = new WizardDescriptor.Panel[]{
                new ThemeWizardWizardPanel1(),
                panel2
            };
    ...
    public Set<FileObject> instantiate() throws IOException {
        ...
        this.drupalVersion = NbPreferences.forModule(DrupalDevelTool.class).get("drupalVersion", "");
        ...
        for (int i = 0; i < fileList.size(); i++) {
            ...
            WizardUtils.generateFile(file, this.drupalVersion, "theme", name, src, this.safeName, this.moduleName);
    ...
    public void initialize(WizardDescriptor wizard) {
        this.wizard = wizard;
        wizard.putProperty(WizardDescriptor.PROP_IMAGE, ImageUtilities.loadImage("org/hollyit/drupaldevel/wizards/drupallg.png", true));
